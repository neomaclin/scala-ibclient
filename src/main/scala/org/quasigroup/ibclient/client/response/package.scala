...
enum ResponseMsg:
  ...
  case Position(account: String, contract: Contract, pos: Decimal, avgCost: Double)
      extends ResponseMsg
  ...
  case ErrorDetail(id: Int, errorCode: Int, errorMsg: String,  advancedOrderRejectJson: String)

  case ConnectionClosed extends ResponseMsg

  case ConnectionAck extends ResponseMsg

  case PositionMulti(reqId: Int, account: String, modelCode: String, contract: Contract, pos: Decimal, avgCost: Double) extends ResponseMsg

  case PositionMultiEnd(reqId: Int) extends ResponseMsg

  case AccountUpdateMulti(reqId: Int, account: String, modelCode: String, key: String, value: String, currency: String) extends ResponseMsg

  case AccountUpdateMultiEnd(reqId: Int) extends ResponseMsg

  case SecurityDefinitionOptionalParameter(reqId: Int, exchange: String, underlyingConId: Int, tradingClass: String, multiplier: String, expirations: Set[String], strikes: Set[Double]) extends ResponseMsg
  ...
  case SymbolSamples(reqId: Int, contractDescriptions: List[ContractDescription]) extends ResponseMsg

  case HistoricalDataEnd(reqId: Int, startDateStr: String, endDateStr: String) extends ResponseMsg

  case MktDepthExchanges(depthMktDataDescriptions: List[DepthMktDataDescription]) extends ResponseMsg

  case TickNews(tickerId: Int, timeStamp: Long, providerCode: String, articleId: String, headline: String, extraData: String) extends ResponseMsg

  case SmartComponents(reqId: Int, theMap: Map[Integer,(String,Char)]) extends ResponseMsg

  case TickReqParams(tickerId: Int, minTick: Double, bboExchange: String, snapshotPermissions: Int) extends ResponseMsg
  ...
  case HistoricalNews(requestId: Int, time: String, providerCode: String, articleId: String, headline: String) extends ResponseMsg
  ...
  case Pnl(reqId: Int, dailyPnL: Double, unrealizedPnL: Double, realizedPnL: Double) extends ResponseMsg

  case PnlSingle(reqId: Int, pos: Nothing, dailyPnL: Double, unrealizedPnL: Double, realizedPnL: Double, value: Double) extends ResponseMsg

  case HistoricalTicks(reqId: Int, ticks: List[HistoricalTick], done: Boolean) extends ResponseMsg

  case HistoricalTicksBidAsk(reqId: Int, ticks: List[HistoricalTickBidAsk], done: Boolean) extends ResponseMsg

  case HistoricalTicksLast(reqId: Int, ticks: List[HistoricalTickLast], done: Boolean) extends ResponseMsg

  case TickByTickAllLast(reqId: Int, tickType: Int, time: Long, price: Double, size: Decimal, tickAttribLast: TickAttribLast, exchange: String, specialConditions: String) extends ResponseMsg

  case TickByTickBidAsk(reqId: Int, time: Long, bidPrice: Double, askPrice: Double, bidSize: Decimal, askSize: Decimal, tickAttribBidAsk: TickAttribBidAsk) extends ResponseMsg
  ...
  case HistoricalSchedule(reqId: Int, startDateTime: String, endDateTime: String, timeZone: String, sessions: List[HistoricalSession]) extends ResponseMsg
